...
public interface SocketHealingConfig extends Config {
    ...
    @ConfigItem(
            position = 17,
            keyName = "separateOpactiy",
            name = "Use Color Opacity",
            description = "Toggles whether each hp threshold has a different opacity set by the color, or if they all use the Highlight Opacity config"
    )
    ...
    @ConfigItem(
            ...
            description = "Shows the amount of hp players have in the right click menu"
    )
    ...
    @ConfigItem(
            position = 22,
            keyName = "showName",
            name = "Show Name in Overlay",
            description = "Shows the name of the player next to their hp"
    )
    ...
    @ConfigItem(
            position = 23,
            keyName = "dontShowHp",
            name = "Dont Show HP Threshold",
            description = "Don't display overlay if their hp is at or above a threshold"
    )
    ...
    @ConfigItem(
            position = 24,
            keyName = "dontShowHpThreshold",
            name = "HP Threshold",
            description = "Set the threshold to not display hp overlay at",
    ...
    @ConfigItem(
            position = 25,
            keyName = "dontShowHpMode",
            name = "Dont Show HP Mode",
            description = "Don't display overlay if their hp is at or above a threshold",
            hidden = true,
            unhide = "dontShowHp"
    )
    ...
    @ConfigItem(
            position = 26,
            keyName = "setHighestPriority",
            name = "Set Highest Priority",
            description = "Displays overlays above widgets(Bank, inventory, teleport menus)<br>Must turn plugin off and on to work"
    )
